...
import { getDateTime, getVolume } from "../utils";
...
export class GetExRightInfo extends BaseParser {
  ...
  parseResponse(bodyBuf: Buffer) {
    ...
    for (let i = 0; i < num; i++) {
      ...
      rows.push({
        ...
        category,
        name:
          EX_RIGHT_CATEGORY_MAPPING[
            category as keyof typeof EX_RIGHT_CATEGORY_MAPPING
          ] || category,
        fenhong,
        peigujia,
        songzhuangu,
